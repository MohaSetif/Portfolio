<script lang="ts">
  ...
  export let raysOrigin: 'top-center' | 'top-left' | 'top-right' | 'right' | 'left' | 'bottom-center' | 'bottom-right' | 'bottom-left' = 'top-center';
...
<div
  ...
  class="w-full h-full pointer-events-none overflow-hidden relative {className}"
  style="z-index: 3;"
/>
